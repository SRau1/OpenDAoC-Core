...
{
	/// <summary>
	/// The Power Consumption bonus percent calculator
	///
	...
	/// </summary>
	[PropertyCalculator(eProperty.PowerConsumption)]
	public class PowerConsumptionPercentCalculator : PropertyCalculator
	{
