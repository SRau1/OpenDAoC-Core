...
namespace DOL.GS
{
    ...
    public class GamePlayer : GameLiving, IGameStaticItemOwner, IPooledList<GamePlayer>
    {
        ...
        public string ItemBonusName(int BonusType)
        {
            ...
            // For skill bonuses (>= 20) and other properties, use SkillBase.GetPropertyName
            if (string.IsNullOrEmpty(BonusName) && BonusType >= 20)
            {
                BonusName = SkillBase.GetPropertyName((eProperty)BonusType);
            }
